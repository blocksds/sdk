# BlocksDS SDK examples: Filesystems
...
- `device_io_basic`: It shows how to add a new custom filesystem to libnds.
...
- `nitrofs_posix`: It shows how to access files in NitroFS using POSIX functions.

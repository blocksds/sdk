# Loading backgrounds with a reference palette

This example shows how to load backgrounds that share a palette that has been
set as a reference in an external file.

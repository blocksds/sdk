# BlocksDS SDK examples: 2D graphics
...
- `bg_ext_palette_multiple`: It converts an image to use multiple extended palettes.
...
- `bg_scroll_bigmap`: It scrolls an 8 bpp tiled background bigger than the hardware limits.

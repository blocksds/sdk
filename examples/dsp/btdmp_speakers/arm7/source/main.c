...
void arm_dsp_ratio_value32_handler(u32 command, void *userdata)
{
    REG_SNDEXTCNT = SNDEXTCNT_ENABLE | SNDEXTCNT_FREQ_32KHZ
                  | SNDEXTCNT_RATIO(command);
}
...
int main(int argc, char *argv[])
{
    ...
    REG_SNDEXTCNT = SNDEXTCNT_ENABLE | SNDEXTCNT_FREQ_32KHZ
                  | SNDEXTCNT_RATIO(4); // 50% DSP, 50% ARM7

    fifoSetValue32Handler(FIFO_USER_01, arm_dsp_ratio_value32_handler, 0);

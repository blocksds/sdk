...
// This example shows how to draw a simple 3D box that is affected by lighting.
// You can change culling to see how the back faces are illuminated.
...
void draw_box(float bx_, float by_, float bz_, float ex_, float ey_, float ez_)
{
    ...
    glBegin(GL_QUADS);
        ...
        // Normal vectors face away from the polygon
        glNormal3f(0, 0, -1);

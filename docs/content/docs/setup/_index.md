...
If you are using MinGW, WSL, or any similar environment, follow the Linux
...
{{< cards cols="1" >}}
  {{< card icon="cog" link="docker" title="Setup guide" >}}
{{< /cards >}}
...
{{< cards cols="1" >}}
  {{< card icon="cog" link="from_source" title="Setup guide" >}}
{{< /cards >}}
